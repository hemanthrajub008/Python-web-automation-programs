...
file_path_fromos = os.getcwd() + "/web_Automation_Test_data.xlsx"
...
def vwo_login(username, password):
    ...
    if result != "https://app.vwo.com/#/dashboard":
        ...
        heading_element = driver.find_element(By.XPATH, "//span[@class='Fw(semi-bold) ng-binding']")
        assert heading_element.text == "Test Ac"
